...
pkgdatadir = $(datadir)/homegar-homematicwired
pkgincludedir = $(includedir)/homegar-homematicwired
pkglibdir = $(libdir)/homegar-homematicwired
pkglibexecdir = $(libexecdir)/homegar-homematicwired
...
OTOOL = 
OTOOL64 = 
PACKAGE = homegar-homematicwired
PACKAGE_BUGREPORT = sathya@laufers.net
PACKAGE_NAME = homegar-homematicwired
PACKAGE_STRING = homegar-homematicwired 0.6.0-1032
PACKAGE_TARNAME = homegar-homematicwired
PACKAGE_URL = 
